		...
		<div className="space-y-4 animate-pulse">
			...
			<div className="flex gap-3">
				...
				<div className="flex-1 max-w-[70%] space-y-2">
					...
					<div className="bg-gray-200 dark:bg-gray-700 rounded-lg rounded-bl-sm p-4 space-y-2">
			...
			<div className="flex justify-end">
				<div className="bg-gray-300 dark:bg-gray-600 rounded-lg rounded-br-sm p-4 max-w-[70%] space-y-2">
					<div className="h-4 bg-gray-400 dark:bg-gray-500 rounded w-48" />
				</div>
			</div>
